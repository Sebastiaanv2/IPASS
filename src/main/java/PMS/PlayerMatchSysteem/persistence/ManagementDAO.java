...
public class ManagementDAO extends BaseDAO {
    ...
    public boolean updateRule1(double r){
        boolean success = false;
        try {
            Connection con = super.getConnection();
            String query = "UPDATE management set rule1 = ?";
            PreparedStatement pstmt = con.prepareStatement(query);
            pstmt.setDouble(1,r);
            pstmt.executeUpdate();
            success = true;
    ...
    public boolean updateRule2(double r){
        boolean success = false;
        try {
            Connection con = super.getConnection();
            String query = "UPDATE management set rule2 = ?";
            PreparedStatement pstmt = con.prepareStatement(query);
            pstmt.setDouble(1,r);
            pstmt.executeUpdate();
            success = true;
    ...
    public boolean updateRule3(double r){
        boolean success = false;
        try {
            Connection con = super.getConnection();
            String query = "UPDATE management set rule3 = ?";
            PreparedStatement pstmt = con.prepareStatement(query);
            pstmt.setDouble(1,r);
            pstmt.executeUpdate();
            success = true;
    ...
    public boolean updateRule4(double r){
        boolean success = false;
        try {
            Connection con = super.getConnection();
            String query = "UPDATE management set rule4 = ?";
            PreparedStatement pstmt = con.prepareStatement(query);
            pstmt.setDouble(1,r);
            pstmt.executeUpdate();
            success = true;
    ...
    public boolean updateRule5(double r){
        boolean success = false;
        try {
            Connection con = super.getConnection();
            String query = "UPDATE management set rule5 = ?";
            PreparedStatement pstmt = con.prepareStatement(query);
            pstmt.setDouble(1,r);
            pstmt.executeUpdate();
            success = true;
